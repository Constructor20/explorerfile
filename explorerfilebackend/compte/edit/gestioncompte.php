    ...
    <?php foreach ($users as $user): ?>
        <div class="window">
            <div class="toggle-header">
                ...
                <span class="username"><?php echo htmlspecialchars(
                    $user["username"],
                ); ?></span>
            </div>
            <div class="window-body" style="display: none;">
                <form action="../compte/compteadmininc.php" method="POST">
                    <div class="field-row-stacked">
                        ...
                        <input type="hidden" name="user_id" value="<?php echo htmlspecialchars(
                            $user["id"],
                        ); ?>">
                    </div>
                    <div class="field-row-stacked">
                    ...
                    <div class="field-row-stacked">
                        <input type="checkbox" id="showUpdate<?php echo $user[
                            "id"
                        ]; ?>" onchange="toggleUpdateButtonAdmin(this)">
                        <label for="showUpdate<?php echo $user[
                            "id"
                        ]; ?>">Je veux modifier mes informations</label>
                    </div>

                    <div class="field-row-stacked" id="updateButtonContainer<?php echo $user[
                        "id"
                    ]; ?>" style="display: none;">
                        <button type="submit" class="button" name="update_account" data="baba" id="<?php echo $user[
                            "id"
